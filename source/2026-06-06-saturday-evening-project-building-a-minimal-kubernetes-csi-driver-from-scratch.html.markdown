...
В ```NodePublishVolume``` мы не используем внешнее хранилище, а просто [пишем в директорию на ноде](https://github.com/dronov/minimal-csi-driver/blob/main/pkg/driver/node.go#L33). Изначально я, как и автор оригинальной статьи, не думал о Ceph, NFS и реализации хранения данных где-то в сети.
...
I haven't had any of 'personal' Saturday's hackathons for a while, though they [used to be](https://www.dronov.net/2017/03/13/how-to-best-at-hackathon.html) a lot more frequent than just on Saturdays.
